<div>
            ...
            <x-table.table>
                ...
                <x-slot name="body">
                    @forelse ($regions as $region)
                        <x-table.row>
                            <x-table.cell>{{ $region->name }}</x-table.cell>
                            <x-table.cell>{{ $region->description }}</x-table.cell>
                            <x-table.cell>
                                <x-button.link wire:click="edit({{ $region->id }})">Edit</x-button.link>
                            </x-table.cell>
                        </x-table.row>
                    @empty
                        <x-table.row>
    ...
    <form wire:submit.prevent="save">
        <x-modal.dialog wire:model.defer="showEditModal">
            <x-slot name="title">Edit Region</x-slot>
